...
@section('description', 'Portal da Coordenação de Gestão de Tecnologia da Informação do IFPE Campus Garanhuns. Acesse nossos serviços e sistemas.')
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <article class="card info-card h-100">
                    ...
                    <img src="{{ Storage::url($informe->featured_image) }}" class="card-img-top" alt="{{ $informe->title }}" style="height: 200px; object-fit: cover;">
                    @endif
                    <div class="card-body">
                        <h5 class="card-title">
