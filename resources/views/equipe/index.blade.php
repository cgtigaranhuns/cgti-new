...
@section('description', 'Conheça a equipe da Coordenação de Gestão de Tecnologia da Informação do IFPE Campus
Garanhuns.')
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 text-center mb-3 mb-md-0">
                            <div class="team-photo-container">
                                @if($membro->foto)
                                <img src="{{ asset('storage/'.$membro->foto) }}" class="team-photo">
                                @else
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="d-flex gap-2 mt-3">
                                @if($membro->email)
                                <a href="mailto:{{ $membro->email }}" class="btn btn-outline-primary btn-sm"
                                    title="Email">
                                    <i class="bi bi-envelope"></i>
                                </a>
                                @endif
                                @if($membro->telefone)
                                <a href="tel:{{ $membro->telefone }}" class="btn btn-outline-primary btn-sm"
                                    title="Telefone">
