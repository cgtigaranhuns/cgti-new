...
@section('description', 'Conheça a Coordenação de Gestão de Tecnologia da Informação do IFPE Campus Garanhuns, nossa missão, visão e objetivos.')
...
<div class="container">
    ...
    <div class="row mb-5">
        ...
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="text-center">
                <div class="bg-primary text-white rounded-circle d-inline-flex align-items-center justify-content-center mb-3" style="width: 80px; height: 80px;">
                    <i class="bi bi-network-widescreen" style="font-size: 2rem;"></i>
                </div>
